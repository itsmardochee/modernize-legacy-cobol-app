...
class Operations:
    ...
    def __init__(self):
        ...
        self.final_balance = Decimal(
            "1000.00"
        )  # Initial balance equivalent to PIC 9(6)V99 VALUE 1000.00
    ...
    def _handle_total_operation(self):
        ...
        self.final_balance = self.data_program.execute_operation(
            "read", self.final_balance
        )
